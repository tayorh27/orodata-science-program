...
export class MyChartComponent implements OnInit {
    ...
    // "Life Expectancy", "Population Density", "State Budget Allocations", "Covid-Support Measures", "Income Support Measures"
    subDataTracker = [
        ...
        { "name": "governance", "options": ["Select option", "FGN Covid-19 Support to State"] },
    ...
    onSubTrackerChanged(evt: any) {
        ...
        if (evt.target.value === "Total Confirmed Covid-19 Cases") {
            ...
            this.last_update_date = "March 23, 2022"
            return
        }
